...
<div id="scenes">
	<div>
		...
		<div class="screen_scene" id="screen_scene_{$scene->id}" style="background: url({$base_dir}img/scenes/{$scene->id}-scene_default.jpg); height:{$largeSceneImageType.height}px; width:{$largeSceneImageType.width}px;{if !$scene@first} display:none;{/if}">
