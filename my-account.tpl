...
<div class="row addresses-lists">
	<div class="card card-primary">
		<ul class="nav nav-tabs nav-tabs-transparent indicator-danger nav-tabs-full nav-tabs-5" role="tablist">
            ...
            {/if}
            <li><a href="{$link->getPageLink('history', true)|escape:'html':'UTF-8'}" title="{l s='Orders'}"><i class="fa fa-list-alt"></i><span>{l s='Order history and details'}</span></a></li>
            {if $returnAllowed}
            ...
            <li><a href="{$link->getPageLink('addresses', true)|escape:'html':'UTF-8'}" title="{l s='Addresses'}"><i class="fa fa-map-marker"></i><span>{l s='My addresses'}</span></a></li>
            <li><a href="{$link->getPageLink('identity', true)|escape:'html':'UTF-8'}" title="{l s='Information'}"><i class="fa fa-address-book"></i><span>{l s='My personal information'}</span></a></li>
{if $voucherAllowed || isset($HOOK_CUSTOMER_ACCOUNT) && $HOOK_CUSTOMER_ACCOUNT !=''}
            {if $voucherAllowed}
                <li><a href="{$link->getPageLink('discount', true)|escape:'html':'UTF-8'}" title="{l s='Vouchers'}"><i class="fa fa-ticket"></i><span>{l s='My vouchers'}</span></a></li>
            {/if}
