		...
		<div class="card card-primary card-block">
			...
			<div id="image-block" class="clearfix">
				...
				{elseif $product->specificPrice && $product->specificPrice.reduction && $productPriceWithoutReduction > $productPrice}
					<span class="btn btn-warning btn-sm btn-block btn-raised mt-2 no-mb">{l s='Reduced price!'}</span>
				{/if}
				{if $have_image}
        ...
        <div class="card-block">
			...
			<div class="content_prices clearfix">
										{if $product->show_price && !isset($restricted_country_mode) && !$PS_CATALOG_MODE}
											<!-- prices -->
											<div>
												<h2 class="color-success no-m text-normal" itemprop="offers" itemscope itemtype="https://schema.org/Offer">{strip}
			...
			{if ($display_qties == 1 && !$PS_CATALOG_MODE && $PS_STOCK_MANAGEMENT && $product->available_for_order)}
				...
				{* numero de item que hay en stock *}
			...
			<h4 id="availability_statut"{if !$PS_STOCK_MANAGEMENT || ($product->quantity <= 0 && !$product->available_later && $allow_oosp) || ($product->quantity > 0 && !$product->available_now) || !$product->available_for_order || $PS_CATALOG_MODE} style="display: none;"{/if}>
					...
					<div class="box-info-product">
						...
						<div class="product_attributes clearfix">
							...
							<p id="quantity_wanted_p"{if (!$allow_oosp && $product->quantity <= 0) || !$product->available_for_order || $PS_CATALOG_MODE} style="display: none;"{/if}>
								...
								<a href="#" data-field-qty="qty" class="btn btn-raised btn-danger product_quantity_down">
									<span><i class="fa fa-minus"></i></span>
								</a>
								<a href="#" data-field-qty="qty" class="btn btn-raised btn-success product_quantity_up">
